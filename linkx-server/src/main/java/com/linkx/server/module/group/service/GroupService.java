...
public interface GroupService {
    ...
    List<GroupHighlightItemDTO> listGroupHighlights(Long userId, Long groupId);

    void addGroupHighlight(Long operatorId, Long groupId, Long messageId, String title);

    void removeGroupHighlight(Long operatorId, Long groupId, Long highlightId);
